...
import com.example.demo1.components.props.BaseProp
import com.example.demo1.utilites.DragContext
...
open class BaseGraphNode(nodeName: String, position: Point2D = Point2D(.0, .0)) : VBox() {
    ...
    init {
        ...
        nodeHeader = VBox()
        nodeHeader.padding = Insets(5.0, .0, 5.0, 5.0)
        ...
        nodeBody.padding = Insets(5.0, .0, 5.0, .0)
