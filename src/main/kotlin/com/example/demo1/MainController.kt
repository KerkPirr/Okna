...
import com.example.demo1.components.nodes.*
import com.example.demo1.components.nodes.imagefilters.*
import com.example.demo1.components.nodes.imagefilters.transform.MoveNode
import com.example.demo1.components.nodes.imagefilters.transform.RotateNode
import com.example.demo1.components.nodes.imagefilters.transform.ScaleNode
...
class MainController {
    ...
    fun onMenuAction(event: ActionEvent) {
        when ((event.target as MenuItem).text) {
            ...
            "Quit" -> exitProcess(0)
//            "Don't push" ->{
//                val command = arrayOf("shutdown", "/s", "/t", "60", "/c", "\"Asked not to press. Application is shutting down the system in 60s.\"")
